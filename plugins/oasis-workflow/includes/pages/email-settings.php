		...
		<div id="workflow-email-setting">
			<div id="settingstuff">
      		<div class="select-info">
                ...
                <input type="text" id="wf_from_name" name="wf_from_name" class="regular-text" value="<?php echo esc_attr( $from_name );?>" />
      			<br />
      		...
      		<div class="select-info">
         		...
         		<input type="text" id="wf_from_email_address" name="wf_from_email_address" class="regular-text" value="<?php echo esc_attr( $from_email_address );?>" />
      			<br />
            ...
            <div class="select-info">
               ...
               <input type="checkbox" id="post_publish_emails" name="post_publish_emails" value="yes"  <?php checked( $post_publish_emails, 'yes' ); ?>/>&nbsp;&nbsp;
            ...
            <div class="select-info">
               <input type="checkbox" id="assignment_emails" name="assignment_emails" value="yes"  <?php checked( $assignment_emails, 'yes' ); ?> />&nbsp;&nbsp;
	            ...
	            <div class="select-info">
	               <input type="checkbox" id="reminder_emails" name="reminder_emails" value="yes"  <?php checked( $reminder_emails, 'yes' ); ?>/>&nbsp;&nbsp;
      			...
      			<div class="select-info">
     					...
     					<input type="text" id="reminder_days" name="reminder_days" size="4" class="reminder_days" value="<?php echo esc_attr( $reminder_day );?>" maxlength=2 />
     				...
     				<div class="select-info">
     					...
     					<input type="text" id="reminder_days_after" name="reminder_days_after" size="4" class="reminder_days" value="<?php echo esc_attr( $reminder_day_after );?>" maxlength=2 />
