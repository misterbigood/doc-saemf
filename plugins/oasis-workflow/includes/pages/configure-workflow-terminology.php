    	...
    	<div id="workflow-terminology-setting">
			<div id="settingstuff">
        		<div class="select-info">
                   ...
                   <label for="action_submit" class="settings-title"><?php echo __( "Submit to Workflow", "oasisworkflow" ) . __( " Label", "oasisworkflow" ) ?></label>
	             </div>
	             <div class="half-width left">   
                    <input type="text" class="regular-text" id="action_submit" name="action_submit" value="<?php echo esc_attr( $submit_to_workflow ); ?>" />
        		...
        		<div class="select-info">
        			<div class="half-width left">
                    <label for="sign_off" class="settings-title"><?php echo __( "Sign Off", "oasisworkflow" ) . __( " Label", "oasisworkflow" ) ?></label>
                </div>
                <div class="half-width left">
                    <input type="text" class="regular-text" id="sign_off" name="sign_off" value="<?php echo esc_attr( $sign_off ); ?>" />
            ...
            <div class="select-info">
                <div class="half-width left">
                    <label for="assign_actors" class="settings-title"><?php echo __( "Assign Actor(s)", "oasisworkflow" ) . __( " Label", "oasisworkflow" ) ?></label>
                </div>
                <div class="half-width left">
                    <input type="text" class="regular-text" id="assign_actors" name="assign_actors" value="<?php echo esc_attr( $assign_actors ); ?>" />
            ...
            <div class="select-info">
                <div class="half-width left">
                    <label for="due_date" class="settings-title"><?php echo __( "Due Date", "oasisworkflow" ) . __( " Label", "oasisworkflow" ) ?></label>
                </div>
                <div class="half-width left">
                    <input type="text" class="regular-text" id="due_date" name="due_date" value="<?php echo esc_attr( $due_date ); ?>" />
            ...
            <div class="select-info">
                <div class="half-width left">
                    <label for="publish_date" class="settings-title"><?php echo __( "Publish Date", "oasisworkflow" ) . __( " Label", "oasisworkflow" ) ?></label>
                </div>
                <div class="half-width left">
                    <input type="text" class="regular-text" id="publish_date" name="publish_date" value="<?php echo esc_attr( $publish_date ); ?>" />
            ...
            <div class="select-info">
                <div class="half-width left">
                    <label for="abort_workflow" class="settings-title"><?php echo __( "Abort Workflow", "oasisworkflow" ) . __( " Label", "oasisworkflow" ) ?></label>
                </div>
                <div class="half-width left">
                    <input type="text" class="regular-text" id="abort_workflow" name="abort_workflow" value="<?php echo esc_attr( $abort_workflow ); ?>" />
            ...
            <div class="select-info">
                <div class="half-width left">
                    <label for="workflow_history" class="settings-title"><?php echo __( "Workflow History", "oasisworkflow" ) . __( " Label", "oasisworkflow" ) ?></label>
                </div>
                <div class="half-width left">
                    <input type="text" class="regular-text" id="workflow_history" name="workflow_history" value="<?php echo esc_attr( $workflow_history ); ?>" />
