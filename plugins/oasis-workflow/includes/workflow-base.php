...
class FCWorkflowBase
{
   ...
   static function get_users_by_role( $role, $post_id = null, $decision=null ) {
      global $wpdb;
      if ( count( $role ) > 0 ) {
         $user_string = array();
         $post_author_id = "";
   ...
   static function format_date_for_display_and_edit( $ddate ) {
	...
	static function get_page_link($count_posts,$pagenum,$per_page=20, $action = null)
	{
...
{
	FCWorkflowCRUD::delete_workflow();
}
?>