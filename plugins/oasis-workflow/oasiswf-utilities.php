			...
			$str = '<div style="width:90%; float:left;  margin: 0px 50px 5px 7px; padding: 10px 10px 10px 10px; border: 1px solid #ddd; background-color:#FFFFE0;">
	      			...
	      			<div style="width:80%; float:left; align: center">' .
	                	'<p>' .
						 	...
						 	'<a target="_blank" href="https://www.oasisworkflow.com/workflow-support-for-updating-published-content">"Revise published content and add workflow support to revised content"</a>, ' .
						 	'<a target="_blank" href="http://www.oasisworkflow.com/auto-submit-to-workflow">"Auto Submit"</a>, ' .
						 	'<a target="_blank" href="https://www.oasisworkflow.com/extensions/oasis-workflow-teams">"Teams"</a>, '.
...
/*
   ...
   static function owf_dropdown_post_types( $selected_option ) {
      $selected_row = '';
      // get all custom types
      $types = self::owf_get_post_types();
      $selected = '';
