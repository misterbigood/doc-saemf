jQuery(document).ready(function() {	
	...
	var get_step_data = function(){
		...
		//-------process info--------
		syncTextarea();
		processinfo["assign_subject"] = jQuery.trim( jQuery("#assignment-email-subject").val().escapeSpecialChars() );
		processinfo["assign_content"] = jQuery.trim( jQuery("#assignment-email-content").val().escapeSpecialChars() );
		processinfo["reminder_subject"] = jQuery.trim( jQuery("#reminder-email-subject").val().escapeSpecialChars() );
		processinfo["reminder_content"] = jQuery.trim( jQuery("#reminder-email-content").val().escapeSpecialChars() );
	...
	var save_step_data = function(){
		...
		data = {
				action: 'step_save' ,
				wfid: jQuery.trim( jQuery(document).find("#wf_id").val().escapeSpecialChars() ), 
				stepgpid: jQuery.trim( jQuery(document).find( "#" + step_gpid ).attr("id").escapeSpecialChars() ),
				stepid: jQuery.trim( jQuery(document).find( "#" + step_gpid ).attr("db-id").escapeSpecialChars() ),
