...
if($_GET['delete-vendor'] != ""){
	...
	DELETE FROM ".$wpdb->prefix."options WHERE option_id = ".sanitize_text_field($_GET['delete-vendor'])."
...
<form action="admin.php?page=sp-client-document-manager-vendors" method="post" style="margin:15px">'.wp_nonce_field( 'cdm_nonce', 'cdm_nonce', true, false ).'
